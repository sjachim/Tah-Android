...
//    0000ffe1-0000-1000-8000-00805f9b34fb
    public static String ServiceUid="0000ffe0-0000-1000-8000-00805f9b34fb";
    public static String CharaUid="0000ffe1-0000-1000-8000-00805f9b34fb";
...
///**
// * Created by adityamathur on 01/04/15.
// */
...
//
//                //               System.out.println("keyhash==="+printKeyHash(ShareFragment.this));
//                try{
//
//
...
//                SessionStore.save(mFacebook, ShareFragment.this);
//                postToFacebook("http://Google.com","demo","demo");
//            }
//            catch( Exception error ) {
//                Toast.makeText(ShareFragment.this, error.toString(), Toast.LENGTH_SHORT).show();
//            }
...
//    public  void fbLogin()
//    {
//        init(ShareFragment.this, mFacebook, new String[]{"publish_stream","email"});
//    }
...
//        @Override
//        public void onAuthSucceed(){
//            SessionStore.save(mFb, getBaseContext());
//        }
//
//        @Override
//        public void onAuthFail(String error)
...
//
//            mFacebook.dialog(ShareFragment.this,"feed",params,new Facebook.DialogListener() {
//
//                @Override
...
//                    Toast.makeText(getBaseContext(), "Oops, something went wrong, can you please try again?",Toast.LENGTH_SHORT).show();
//                }
//
//                @Override
//                public void onComplete(Bundle arg0) {
//                    Toast.makeText(getBaseContext(), "share on fb",Toast.LENGTH_SHORT).show();
